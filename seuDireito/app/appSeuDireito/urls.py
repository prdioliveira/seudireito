...
urlpatterns = [
    ...
    url(r'^empresa/(?P<pk>[0-9]+)/deletar/$', views.empresa_delete, name='empresa_deletar'),
    ...
    url(r'^ordem-servico/(?P<pk>[0-9]+)/deletar/$', views.ordem_servico_delete, name='ordem_servico_deletar'),
    ...
    url(r'^ordem-servico/(?P<ordem_servico_id>[0-9]+)/proposta/(?P<pk>[0-9]+)/deletar/$', views.proposta_delete, name='proposta_deletar'),
